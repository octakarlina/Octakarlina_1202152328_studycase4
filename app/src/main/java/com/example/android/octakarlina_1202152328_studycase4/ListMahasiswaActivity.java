...
/**
 * Created by Octa Karlina on 18/03/2018.
 */
...
public class ListMahasiswaActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String[] namaMahasiswa = {"Octa", "Karlina", "Tata", "Arlin", "Daniel", "Jihoon", "Daehwi", "Jaehwan", "Ong", "Woojin", "Youngmin",
            "Donghyun", "Jisung", "Minhyun", "Baejin", "Sungwoon", "Jungkook", "Sewoon",
            "Gwanghyun", "Mina", "Doyeon"};
    ...
    public class loadNamaMahasiswa extends AsyncTask<String[], Integer, String[]>{
        ...
        protected void onPostExecute(final String[] s) {
            //menampilkan handler untuk delay dialog semua 1200 millisecond
